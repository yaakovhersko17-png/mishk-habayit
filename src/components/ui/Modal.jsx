  ...
  return (
    ...
    >
      <div
        ...
        style={{
          width:'100%',maxWidth:sizes[size],maxHeight:'90vh',overflowY:'auto',
          background:'#1a1a2e',border:'1px solid rgba(255,255,255,0.1)',
          borderRadius:'1rem',animation:'cardEnter 0.2s ease',
        }}
      >
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'1.25rem 1.5rem',borderBottom:'1px solid rgba(255,255,255,0.06)'}}>
          ...
          <button onClick={onClose} style={{background:'none',border:'none',cursor:'pointer',color:'#64748b',padding:'0.25rem',borderRadius:'0.5rem',display:'flex'}}><X size={18}/></button>
        </div>
