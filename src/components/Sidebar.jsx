...
const navItems = [
  ...
  { to: '/insights',    icon: Lightbulb,       label: 'דף חכם' },
    ...
    <div style={{
      ...
      <div style={{padding:'1.5rem 1rem 1rem',borderBottom:'1px solid rgba(255,255,255,0.06)'}}>
        <div style={{display:'flex',alignItems:'center',gap:'0.75rem'}}>
          <div style={{width:36,height:36,borderRadius:'0.75rem',background:'linear-gradient(135deg,#6c63ff,#8b5cf6)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'1.1rem'}}>🏠</div>
          <div>
      ...
      {profile && (
        <div style={{padding:'0.75rem 1rem',margin:'0.75rem',borderRadius:'0.75rem',background:'rgba(108,99,255,0.1)',border:'1px solid rgba(108,99,255,0.15)'}}>
          <div style={{display:'flex',alignItems:'center',gap:'0.5rem'}}>
            <div style={{width:28,height:28,borderRadius:'50%',background:'linear-gradient(135deg,#6c63ff,#a78bfa)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'0.8rem',fontWeight:700,color:'#fff'}}>
              {profile.name[0]}
            </div>
            <div>
              <div style={{fontSize:'0.8rem',fontWeight:600,color:'#e2e8f0'}}>{profile.name}</div>
